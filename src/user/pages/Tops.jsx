...
function Tops() {
  ...
  // to get all Tops
  const getAllTopsUser = async (token, category) => {
  ...
  const filteredProducts = allTops.filter(product => {
    const sizeMatch =
  ...
  return (
    <>
      ...
      <h1 className='my-10 text-center font-bold md:text-xl text-lg'>TOPS FOR WOMEN</h1>
      ...
      {token ? <div className="md:grid grid-cols-[1fr_4fr] md:px-10 px-5 mb-30">
        ...
        <div className='md:mb-0 mb-10'>
          ...
          <button className='p-2 bg-emerald-700 rounded text-sm font-semibold text-white'>Women Clothing Tops</button>

          <h1 className='font-bold text-lg my-6'>Filter By Categories :</h1>

          <div className='my-2 flex'>
            <input type="checkbox" id='Tops' name='filter' className="w-5 h-5 accent-emerald-700" checked={true} readOnly/>
