        ...
        <div className="md:grid grid-cols-[1fr_4fr] md:px-10 px-5 mb-30 mt-20 ">
          ...
          <div className='md:mb-0 mb-10'>
            ...
            <div className='my-2 flex'>
              <input type="checkbox" id='Dresses' name='filter' className="w-5 h-5 accent-emerald-700" />
              <label htmlFor="Dresses" className='ms-3'>Dresses</label>
            </div>

            <div className='my-2 flex'>
              <input type="checkbox" id='Tops' name='filter' className="w-5 h-5 accent-emerald-700" />
              <label htmlFor="Tops" className='ms-3'>Tops</label>
            </div>

            <div className='my-2 flex'>
              <input type="checkbox" id='Bottoms' name='filter' className="w-5 h-5 accent-emerald-700" />
              <label htmlFor="Bottoms" className='ms-3'>Bottoms</label>
            </div>

            <div className='my-2 flex'>
              <input type="checkbox" id='All Collection' name='filter' className="w-5 h-5 accent-emerald-700" />
              <label htmlFor="All Collection" className='ms-3'>All Collection</label>
            </div>
          ...
          <div className='md:grid grid-cols-4 gap-x-5'>
            ...
            <div className='p-5 flex justify-center items-center flex-col md:mb-5 mb-10 shadow-lg/30'>
              <img src="https://www.stylestone.in/cdn/shop/products/4004BlkBellyCut_3.jpg?v=1659509978" alt="book image" style={{ width: '100%', height: '300px' }} />
